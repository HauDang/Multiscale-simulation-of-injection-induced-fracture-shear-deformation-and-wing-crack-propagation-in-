...
disp, pres, traction = setup.export_results()
# displacement = disp.ravel(order="F")


# gb = setup.create_grid()
# g2d = gb.grids_of_dimension(2)
# g1d = gb.grids_of_dimension(1)
# data_node = gb.node_props(g2d)
# data_edge = gb.edge_props((g2d, g1d))
# mg = data_edge['mortar_grid']
