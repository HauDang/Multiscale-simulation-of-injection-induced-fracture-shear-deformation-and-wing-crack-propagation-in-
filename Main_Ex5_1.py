...
class ModelSetup(pp.ContactMechanicsBiot, pp.ConformingFracturePropagation):
    def __init__(self, params):
        ...
        self.length_scale = 1
        self.micro_size = 0.5*self.length_scale #0.23 0.33 0.5
        ...
        self.mesh_size_micro = self.mesh_size/2
        self.mesh_args = { "mesh_size_frac": self.mesh_size/2, "mesh_size_min": 1 * self.mesh_size, "mesh_size_bound": 11* self.mesh_size} 
        ...
        self.end_time = 30*60*60
        self.inject_time = [6*60*60, 21*60*60]
        self.time_step = 0.5*60*60
        self.time_step_fix = 0.5*60*60
        ...
        for i in range(len(tips)):
            ...
            for j, fracturej in enumerate(self.fracture):
                ...
                if frac_box:        
                    ...
                    mesh_args = { "mesh_size_frac": self.mesh_size_micro, "mesh_size_min": 2 * self.mesh_size_micro, "mesh_size_bound": 6 * self.mesh_size_micro}
